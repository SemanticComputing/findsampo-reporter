const MAX_NEARBY_DISTANCE_LIMIT = 30;

module.exports = {
  getSmartHelpData: (property) => {
    return `
  ...
  getNearbySmartHelpData: (coords) => {
    ...
    WHERE {
      ?id spatial:nearby (${coords.lat} ${coords.lng} ${MAX_NEARBY_DISTANCE_LIMIT} 'km') .
      ?id a sualt:Find .
